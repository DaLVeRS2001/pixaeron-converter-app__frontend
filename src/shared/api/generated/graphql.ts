...
export type EmailVerificationStatus = 'ALREADY_VERIFIED' | 'EXPIRED' | 'INVALID' | 'VERIFIED';
...
export type PasswordResetStatus = 'ALREADY_USED' | 'EXPIRED' | 'INVALID' | 'RESET';
...
export type MeQuery = {
  me: { id: string; email: string; username: string; emailVerified: boolean };
};
...
export type LoginMutation = {
  login: { id: string; email: string; username: string; emailVerified: boolean };
};
...
export type GoogleLoginMutation = {
  googleLogin: { id: string; email: string; username: string; emailVerified: boolean };
};
...
export type ResendEmailVerificationMutation = {
  resendEmailVerification: { accepted: boolean };
};
      ...
      variableDefinitions: [
        {
          ...
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'GoogleLoginInput' } },
          },
        },
      ],
      selectionSet: {
        ...
        selections: [
          {
            ...
            arguments: [
              {
                kind: 'Argument',
                name: { kind: 'Name', value: 'googleLoginInput' },
                value: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
              },
            ],
            selectionSet: {
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'ResendEmailVerification' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'EmailActionInput' } },
          },
        },
      ],
      selectionSet: {
        ...
        selections: [
          {
            ...
            selectionSet: {
              kind: 'SelectionSet',
              selections: [{ kind: 'Field', name: { kind: 'Name', value: 'accepted' } }],
            },
          },
        ],
      },
      ...
      variableDefinitions: [
        {
          ...
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'AuthTokenInput' } },
          },
        },
      ],
      selectionSet: {
