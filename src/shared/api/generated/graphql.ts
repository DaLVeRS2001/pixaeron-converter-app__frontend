...
export type ConversionEntitlementQuery = { conversionEntitlement: { planCode: ConversionPlanCode, maxBatchFiles: number, maxFileBytes: number, dailyFiles: number | null, remainingToday: number | null, maxConcurrentFiles: number } };
...
export type ConversionBatchQuery = { conversionBatch: { id: string, status: ConversionBatchStatus, fileCount: number, expiresAt: unknown, files: Array<{ id: string, status: ConversionFileStatus, inputBytes: number | null, outputBytes: number | null, outputFormat: string | null, resultKind: ConversionResultKind | null, width: number | null, height: number | null, failureCode: string | null, downloadUrl: string | null }> } };
...
export type CreateConversionBatchMutation = { createConversionBatch: { id: string, status: ConversionBatchStatus, fileCount: number, expiresAt: unknown, batchToken: string | null, files: Array<{ id: string, status: ConversionFileStatus, upload: { url: string, fields: Array<{ name: string, value: string }> } | null }> } };
...
export type CompleteConversionUploadsMutation = { completeConversionUploads: { admittedFiles: number, verifiedFiles: number, missingFiles: number, batch: { id: string, status: ConversionBatchStatus } } };
